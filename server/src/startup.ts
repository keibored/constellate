...
export async function connectDependencies(environment: NodeJS.ProcessEnv) {
  ...
  console.log(`[startup:postgres] Checking PostgreSQL at ${endpoint(databaseUrl, '5432')} and required migrations...`);
  ...
  console.log(`[startup:redis] Connecting to Redis at ${endpoint(redisUrl, '6379')}...`);
